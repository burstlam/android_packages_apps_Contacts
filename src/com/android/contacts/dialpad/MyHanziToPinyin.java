...
public class MyHanziToPinyin {
    ...
    private static MyHanziToPinyin sInstance;
    ...
    protected MyHanziToPinyin(boolean hasChinaCollator) {
        mHasChinaCollator = hasChinaCollator;
    }

    public static MyHanziToPinyin getInstance() {
        synchronized (MyHanziToPinyin.class) {
            if (sInstance != null) {
                return sInstance;
            }
            ...
            for (int i = 0; i < locale.length; i++) {
                if (locale[i].equals(Locale.CHINA)) {
                    ...
                    sInstance = new MyHanziToPinyin(true);
                    return sInstance;
                }
            }
            Log.w(TAG, "There is no Chinese collator, HanziToPinyin is disabled");
            sInstance = new MyHanziToPinyin(false);
            return sInstance;
        }
    }
	...
	public static String getPinYin(String input) {
		...
		ArrayList<Token> tokens = MyHanziToPinyin.getInstance().get(input);
